...
type
  TDelphiLibrary = (dlAndroid32, dlAndroid64, dlIOS32, dlIOS64, dlIOSimulator,
    dlOSX32, dlOSX64, dlOSXARM64, dlWin32, dlWin64, dlLinux64);
...
type
  ...
  private
    ...
    procedure SetLibraryAndroid64(const Value: string);
    procedure SetLibraryOSX64(const Value: string);
    procedure SetLibraryOSXARM64(const Value: string);
  public
    ...
    property LibraryOSX64: string read GetLibraryOSX64 write SetLibraryOSX64;
    property LibraryOSXARM64: string read GetLibraryOSXARM64
      write SetLibraryOSXARM64;
    property LibraryAndroid32: string read GetLibraryAndroid32
      write SetLibraryAndroid32;
    property LibraryAndroid64: string read GetLibraryAndroid64
      write SetLibraryAndroid64;
...
procedure TLibraryHelper.GetLibraryNames(AStrings: TStrings);
var
...
begin
  ...
  begin
    case ALibrary of
      ...
      dlAndroid64:
        FLibraryAndroid64.Add(APath, LLibraryPathType);
      dlIOS32:
      ...
      dlOSX64:
        FLibraryOSX64.Add(APath, LLibraryPathType);
      dlOSXARM64:
...
begin
  ...
  RemoveInvalidPaths(FLibraryAndroid64, dlAndroid64);
  ...
  RemoveInvalidPaths(FLibraryOSX64, dlOSX64);
  RemoveInvalidPaths(FLibraryOSXARM64, dlOSXARM64);
...
begin
  ...
  FLibraryAndroid64 := CreateLibraryPaths;
  ...
  FLibraryOSX64 := CreateLibraryPaths;
  FLibraryOSXARM64 := CreateLibraryPaths;
...
begin
  ...
  Result := Result + DeduplicatPaths(FLibraryAndroid64, dlAndroid64);
  ...
  Result := Result + DeduplicatPaths(FLibraryOSX64, dlOSX64);
  Result := Result + DeduplicatPaths(FLibraryOSXARM64, dlOSXARM64);
...
begin
  ...
  try
    ...
    begin
      ...
      ExportDelphiLibrary(FLibraryAndroid64, dlAndroid64);
      ...
      ExportDelphiLibrary(FLibraryOSX64, dlOSX64);
      ExportDelphiLibrary(FLibraryOSXARM64, dlOSXARM64);
...
begin
  case ADelphiLibrary of
    ...
    dlAndroid64:
      AStrings.Text := GetLibraryAndroid64;
    dlIOS32:
    ...
    dlOSX64:
      AStrings.Text := GetLibraryOSX64;
    dlOSXARM64:
      AStrings.Text := GetLibraryOSXARM64;
    dlWin32:
...
begin
  ...
  begin
    ...
    FLibraryAndroid64.FromDelimitedString(LoadLibrary('Android64', LPathType),
      LPathType);
    ...
    FLibraryOSX64.FromDelimitedString(LoadLibrary('OSX64', LPathType),
      LPathType);

    FLibraryOSXARM64.FromDelimitedString(LoadLibrary('OSXARM64', LPathType),
      LPathType);
...
begin
  ...
  Result := Result + RemoveBrowseFromSearchPaths(FLibraryAndroid32, dlAndroid32,
    ASmartEnabled);
  Result := Result + RemoveBrowseFromSearchPaths(FLibraryAndroid64, dlAndroid64,
    ASmartEnabled);
  ...
  Result := Result + RemoveBrowseFromSearchPaths(FLibraryOSX32, dlOSX32,
    ASmartEnabled);
  Result := Result + RemoveBrowseFromSearchPaths(FLibraryOSX64, dlOSX64,
    ASmartEnabled);
  Result := Result + RemoveBrowseFromSearchPaths(FLibraryOSXARM64, dlOSXARM64,
    ASmartEnabled);
...
begin
  ...
  FLibraryAndroid64.Clear(APathType);
  ...
  FLibraryOSX64.Clear(APathType);
  FLibraryOSXARM64.Clear(APathType);
...
function TDelphiInstallation.GetLibraryAndroid64: string;
begin
  Result := GetLibraryPathAsString(FLibraryAndroid64);
end;
...
function TDelphiInstallation.GetLibraryOSX64: string;
begin
  Result := GetLibraryPathAsString(FLibraryOSX64);
end;

function TDelphiInstallation.GetLibraryOSXARM64: string;
begin
  Result := GetLibraryPathAsString(FLibraryOSXARM64);
end;
...
begin
  ...
  begin
    SaveLibrary('Android32', FLibraryAndroid32.AsDelimitedString(LPathType),
      LPathType);
    SaveLibrary('Android64', FLibraryAndroid64.AsDelimitedString(LPathType),
      LPathType);
    ...
    SaveLibrary('OSX64', FLibraryOSX64.AsDelimitedString(LPathType), LPathType);
    SaveLibrary('OSXARM64', FLibraryOSXARM64.AsDelimitedString(LPathType),
      LPathType);
...
procedure TDelphiInstallation.SetLibraryAndroid64(const Value: string);
begin
  SetLibraryPathFromString(Value, FLibraryAndroid64, dlAndroid64);
end;
...
procedure TDelphiInstallation.SetLibraryOSX64(const Value: string);
begin
  SetLibraryPathFromString(Value, FLibraryOSX64, dlOSX64);
end;

procedure TDelphiInstallation.SetLibraryOSXARM64(const Value: string);
begin
