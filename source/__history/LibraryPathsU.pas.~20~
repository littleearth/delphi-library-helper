...
type
  ...
  private
    ...
    FOSX64: TLibraryPaths;
    FOSXARM64: TLibraryPaths;
  ...
  public
    ...
    property OSX64: TLibraryPaths read FOSX64;
    property OSXARM64: TLibraryPaths read FOSXARM64;
    ...
    property Android64: TLibraryPaths read FAndroid64;
...
begin
  ...
  FOSX64 := TLibraryPaths.Create;
  FOSXARM64 := TLibraryPaths.Create;
  FIOS32 := TLibraryPaths.Create;
  FIOS64 := TLibraryPaths.Create;
  FAndroid32 := TLibraryPaths.Create;
  FAndroid64 := TLibraryPaths.Create;
...
begin
  try
    ...
    FreeAndNil(FOSX32);
    FreeAndNil(FOSX64);
    FreeAndNil(FOSXARM64);
    FreeAndNil(FIOS32);
    FreeAndNil(FIOS64);
    FreeAndNil(FAndroid32);
    FreeAndNil(FAndroid64);
...
begin
  ...
  begin
    ...
    LoadSection(AFileName, 'osx64', FOSX64);
    LoadSection(AFileName, 'osx64-' + IntToStr(AProductVersion), FOSX64, True);
    ...
    LoadSection(AFileName, 'android64', FAndroid64);
    LoadSection(AFileName, 'android64-' + IntToStr(AProductVersion),
      FAndroid64, True);
